...
export const MERCENARY_DEFS: MercenaryDef[] = [
  { id: 'merc_shield_bearer', name: 'Garrak', title: 'Shield Bearer', char: '♦', color: '#88ccff', hireCost: 30, stats: { hp: 25, maxHp: 25, attack: 4, defense: 8, speed: 5 }, minFloor: 2, description: 'A sturdy defender who draws enemy attacks.', specialAbility: 'Taunt: enemies prefer attacking Garrak', portraitAsset: 'story/story-mercenary-garrak.png' },
  { id: 'merc_blade_dancer', name: 'Lyra', title: 'Blade Dancer', char: '♣', color: '#88ccff', hireCost: 50, stats: { hp: 18, maxHp: 18, attack: 10, defense: 2, speed: 13 }, minFloor: 4, description: 'A fast fighter who strikes twice.', specialAbility: 'Double Strike: attacks twice per turn', portraitAsset: 'story/story-mercenary-lyra.png' },
  { id: 'merc_healer', name: 'Sera', title: 'War Priestess', char: '♥', color: '#88ffaa', hireCost: 60, stats: { hp: 20, maxHp: 20, attack: 5, defense: 3, speed: 7 }, minFloor: 3, description: 'Heals you each turn.', specialAbility: 'Blessing: heals you 2 HP per turn', portraitAsset: 'story/story-mercenary-sera.png' },
  { id: 'merc_berserker', name: 'Krug', title: 'Berserker', char: '♠', color: '#ff8855', hireCost: 70, stats: { hp: 30, maxHp: 30, attack: 14, defense: 1, speed: 8 }, minFloor: 5, description: 'Hits incredibly hard but takes extra damage.', specialAbility: 'Frenzy: deals double damage when below 50% HP', portraitAsset: 'story/story-mercenary-krug.png' },
  { id: 'merc_assassin', name: 'Shade', title: 'Shadow Assassin', char: '◆', color: '#bb88dd', hireCost: 80, stats: { hp: 15, maxHp: 15, attack: 12, defense: 2, speed: 15 }, minFloor: 6, description: 'Strikes from shadows with lethal precision.', specialAbility: 'Assassinate: 15% chance to instantly kill non-boss enemies', portraitAsset: 'story/story-mercenary-shade.png' },
  { id: 'merc_golem', name: 'Atlas', title: 'War Golem', char: '■', color: '#ccbb88', hireCost: 100, stats: { hp: 60, maxHp: 60, attack: 8, defense: 12, speed: 3 }, minFloor: 8, description: 'An ancient construct. Nearly indestructible.', specialAbility: 'Stone Skin: takes half damage from all sources', portraitAsset: 'story/story-mercenary-atlas.png' },
];
