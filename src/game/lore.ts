...
const ORIGINS_LORE: LoreEntry[] = [
  {
    ...
    artAsset: 'journal/journal-origins.png',
...
const ZONE_LORE: LoreEntry[] = [
  {
    ...
    artAsset: 'journal/journal-zones.png',
...
const BOSS_LORE: LoreEntry[] = [
  // Stone Depths bosses
  {
    ...
    artAsset: 'journal/journal-bosses.png',
...
const CREATURE_LORE: LoreEntry[] = [
  {
    ...
    artAsset: 'journal/journal-creatures.png',
...
const ANCESTOR_LORE: LoreEntry[] = [
  {
    ...
    artAsset: 'journal/journal-ancestors.png',
...
const ARTIFACT_LORE: LoreEntry[] = [
  {
    ...
    artAsset: 'journal/journal-artifacts.png',
...
const FACTION_LORE: LoreEntry[] = [
  {
    ...
    artAsset: 'journal/journal-factions.png',
