...
// ════════════════════════════════════════════════════════════════
//  HELLBORN SKILL TREE
//  Path 0: Inferno    — fire damage, burning
//  Path 1: Damnation  — lifesteal, sustain
//  Path 2: Overlord   — demon mastery, boss killing
// ════════════════════════════════════════════════════════════════

const HELLBORN_TREE: SkillTreeDef = {
  classId: 'hellborn',
  paths: [
    {
      name: 'Inferno',
      color: '#ff4400',
      icon: '🔥',
      description: 'Embrace the flame. Burn everything in your path.',
      nodes: [
        node('hb_i_ignite', 'Ignite', '20% chance to burn enemies for 3 damage over 3 turns', '🔥', '#ff4400',
          1, 0, 1, [],
          { type: 'ability', abilityId: 'hb_ignite' }),
        node('hb_i_atk1', 'Hellfire Strike', '+2 attack', '⚔', '#ff6622',
          1, 0, 1, [],
          { type: 'stat', stat: 'attack', value: 2 }),
        node('hb_i_eruption', 'Eruption', 'Attacks hit adjacent enemies for 50% damage', '💥', '#ff6600',
          2, 0, 1, ['hb_i_ignite', 'hb_i_atk1'],
          { type: 'ability', abilityId: 'hb_eruption' }),
        node('hb_i_atk2', 'Brimstone Fury', '+3 attack', '⚔', '#ff4400',
          2, 0, 1, ['hb_i_ignite', 'hb_i_atk1'],
          { type: 'stat', stat: 'attack', value: 3 }),
        node('hb_i_spd1', 'Flame Dash', '+3 speed', '⚡', '#ff8844',
          2, 0, 1, ['hb_i_ignite', 'hb_i_atk1'],
          { type: 'stat', stat: 'speed', value: 3 }),
        node('hb_i_atk3', 'Infernal Wrath', '+5 attack', '⚔', '#ff2200',
          3, 0, 2, ['hb_i_eruption', 'hb_i_atk2', 'hb_i_spd1'],
          { type: 'stat', stat: 'attack', value: 5 }),
        node('hb_i_boss', 'Demon Slayer', '+35% damage to bosses', '👹', '#ff8800',
          3, 0, 2, ['hb_i_eruption', 'hb_i_atk2', 'hb_i_spd1'],
          { type: 'enemyBonus', enemyKeyword: '__boss__', damagePercent: 35 }),
        node('hb_i_weapon', 'Flame-Forged', '+15% damage with all weapons', '⚔', '#ffaa44',
          3, 0, 2, ['hb_i_eruption', 'hb_i_atk2', 'hb_i_spd1'],
          { type: 'weaponProf', weaponKeyword: '__all__', damagePercent: 15 }),
        node('hb_i_capstone', 'Hellstorm', 'All attacks burn. +50% fire damage. +8 attack.', '🌋', '#ff0000',
          4, 0, 2, ['hb_i_atk3', 'hb_i_boss', 'hb_i_weapon'],
          { type: 'multi', effects: [
            { type: 'stat', stat: 'attack', value: 8 },
            { type: 'activeModifier', modifierId: 'hellborn_always_burn' },
            { type: 'enemyBonus', enemyKeyword: '__all__', damagePercent: 50 },
          ]}),
      ],
    },
    {
      ...
      color: '#cc2200',
      icon: '💀',
      description: 'Feed on suffering. Every kill sustains you.',
      nodes: [
        node('hb_d_drain', 'Soul Siphon', 'Heal 3 HP on kill', '💀', '#cc4444',
          1, 1, 1, [],
          { type: 'ability', abilityId: 'hb_soul_siphon' }),
        node('hb_d_hp1', 'Demon Constitution', '+6 max HP', '❤', '#ff4444',
          1, 1, 1, [],
          { type: 'stat', stat: 'maxHp', value: 6 }),
        node('hb_d_lifesteal', 'Blood Pact', 'Heal 15% of damage dealt', '🩸', '#ff2244',
          2, 1, 1, ['hb_d_drain', 'hb_d_hp1'],
          { type: 'ability', abilityId: 'hb_blood_pact' }),
        node('hb_d_def1', 'Abyssal Hide', '+3 defense', '🛡', '#882222',
          2, 1, 1, ['hb_d_drain', 'hb_d_hp1'],
          { type: 'stat', stat: 'defense', value: 3 }),
        node('hb_d_hp2', 'Infernal Vitality', '+8 max HP', '❤', '#ff6644',
          2, 1, 1, ['hb_d_drain', 'hb_d_hp1'],
          { type: 'stat', stat: 'maxHp', value: 8 }),
        node('hb_d_hp3', 'Eternal Flame', '+10 max HP', '❤', '#ff4422',
          3, 1, 2, ['hb_d_lifesteal', 'hb_d_def1', 'hb_d_hp2'],
          { type: 'stat', stat: 'maxHp', value: 10 }),
        node('hb_d_def2', 'Hellforged Armor', '+5 defense', '🛡', '#cc4400',
          3, 1, 2, ['hb_d_lifesteal', 'hb_d_def1', 'hb_d_hp2'],
          { type: 'stat', stat: 'defense', value: 5 }),
        node('hb_d_regen', 'Undying Flame', 'Regenerate 2 HP per turn', '🔥', '#ff8866',
          3, 1, 2, ['hb_d_lifesteal', 'hb_d_def1', 'hb_d_hp2'],
          { type: 'ability', abilityId: 'hb_regen' }),
        node('hb_d_capstone', 'Lord of Hell', 'Revive once per floor. Max 8 damage per hit. +15 max HP.', '👑', '#ff2200',
          4, 1, 2, ['hb_d_hp3', 'hb_d_def2', 'hb_d_regen'],
          { type: 'multi', effects: [
            { type: 'stat', stat: 'maxHp', value: 15 },
            { type: 'activeModifier', modifierId: 'hellborn_revive' },
            { type: 'activeModifier', modifierId: 'damage_cap_8' },
          ]}),
      ],
    },
    {
      ...
      color: '#ff8800',
      icon: '👹',
      description: 'Command the forces of hell. Dominate all who oppose you.',
      nodes: [
        node('hb_o_fear', 'Terrify', '15% chance enemies flee on sight', '😱', '#ff6600',
          1, 2, 1, [],
          { type: 'ability', abilityId: 'hb_terrify' }),
        node('hb_o_spd1', 'Demon Speed', '+3 speed', '⚡', '#ff8844',
          1, 2, 1, [],
          { type: 'stat', stat: 'speed', value: 3 }),
        node('hb_o_undead', 'Netherbane', '+30% damage to undead', '💀', '#aaddff',
          2, 2, 1, ['hb_o_fear', 'hb_o_spd1'],
          { type: 'enemyBonus', enemyKeyword: '__undead__', damagePercent: 30 }),
        node('hb_o_beast', 'Beast Dominator', '+30% damage to beasts', '🐺', '#88cc44',
          2, 2, 1, ['hb_o_fear', 'hb_o_spd1'],
          { type: 'enemyBonus', enemyKeyword: '__beast__', damagePercent: 30 }),
        node('hb_o_atk1', 'Demonic Authority', '+3 attack', '⚔', '#ff6600',
          2, 2, 1, ['hb_o_fear', 'hb_o_spd1'],
          { type: 'stat', stat: 'attack', value: 3 }),
        node('hb_o_all_weapon', 'Hell-Tempered', '+15% damage with all weapons', '⚔', '#ffcc44',
          3, 2, 2, ['hb_o_undead', 'hb_o_beast', 'hb_o_atk1'],
          { type: 'weaponProf', weaponKeyword: '__all__', damagePercent: 15 }),
        node('hb_o_exploit', 'Exploit Weakness', '+40% to stunned/frozen enemies', '🎯', '#ff8844',
          3, 2, 2, ['hb_o_undead', 'hb_o_beast', 'hb_o_atk1'],
          { type: 'ability', abilityId: 'shared_sharp' }),
        node('hb_o_atk2', 'Wrath of Hell', '+4 attack', '⚔', '#ff4400',
          3, 2, 2, ['hb_o_undead', 'hb_o_beast', 'hb_o_atk1'],
          { type: 'stat', stat: 'attack', value: 4 }),
        node('hb_o_capstone', 'Archfiend', '+50% damage to all. +5 attack. Enemies always burn.', '😈', '#ff0000',
          4, 2, 2, ['hb_o_all_weapon', 'hb_o_exploit', 'hb_o_atk2'],
          { type: 'multi', effects: [
            { type: 'stat', stat: 'attack', value: 5 },
            { type: 'enemyBonus', enemyKeyword: '__all__', damagePercent: 50 },
            { type: 'activeModifier', modifierId: 'hellborn_archfiend_burn' },
          ]}),
      ],
    },
  ],
...
// ════════════════════════════════════════════════════════════════
//  IMPREGNAR SKILL TREE
//  Path 0: Broodmother — spawn, impregnation, minion power
//  Path 1: Pestilence  — poison, disease, AoE
//  Path 2: Parasite     — lifesteal, sustain, survival
// ════════════════════════════════════════════════════════════════

const IMPREGNAR_TREE: SkillTreeDef = {
  classId: 'impregnar',
  paths: [
    {
      name: 'Broodmother',
      color: '#88ff44',
      icon: '🥚',
      description: 'Your spawn are your army. More eggs, stronger offspring.',
      nodes: [
        node('imp_b_fertile', 'Hyper Fertile', 'Impregnation cooldown reduced by 1 turn', '🥚', '#88ff44',
          1, 0, 1, [],
          { type: 'ability', abilityId: 'imp_fast_breed' }),
        node('imp_b_atk1', 'Brood Strength', '+2 attack', '⚔', '#66cc33',
          1, 0, 1, [],
          { type: 'stat', stat: 'attack', value: 2 }),
        node('imp_b_twins', 'Twin Spawns', 'Impregnation produces 2 spawn instead of 1', '🥚', '#aaff66',
          2, 0, 1, ['imp_b_fertile', 'imp_b_atk1'],
          { type: 'ability', abilityId: 'imp_twins' }),
        node('imp_b_atk2', 'Swarm Power', '+3 attack', '⚔', '#88dd22',
          2, 0, 1, ['imp_b_fertile', 'imp_b_atk1'],
          { type: 'stat', stat: 'attack', value: 3 }),
        node('imp_b_spd1', 'Hive Rush', '+3 speed', '⚡', '#aaff88',
          2, 0, 1, ['imp_b_fertile', 'imp_b_atk1'],
          { type: 'stat', stat: 'speed', value: 3 }),
        node('imp_b_atk3', 'Brood Lord', '+5 attack', '⚔', '#66ff00',
          3, 0, 2, ['imp_b_twins', 'imp_b_atk2', 'imp_b_spd1'],
          { type: 'stat', stat: 'attack', value: 5 }),
        node('imp_b_boss', 'Egg Bomber', '+35% damage to bosses', '👹', '#88ff44',
          3, 0, 2, ['imp_b_twins', 'imp_b_atk2', 'imp_b_spd1'],
          { type: 'enemyBonus', enemyKeyword: '__boss__', damagePercent: 35 }),
        node('imp_b_weapon', 'Chitin Arms', '+15% damage with all weapons', '⚔', '#aacc44',
          3, 0, 2, ['imp_b_twins', 'imp_b_atk2', 'imp_b_spd1'],
          { type: 'weaponProf', weaponKeyword: '__all__', damagePercent: 15 }),
        node('imp_b_capstone', 'Hive Queen', 'All enemies auto-impregnated on hit. +8 attack. +50% spawn damage.', '👑', '#44ff00',
          4, 0, 2, ['imp_b_atk3', 'imp_b_boss', 'imp_b_weapon'],
          { type: 'multi', effects: [
            { type: 'stat', stat: 'attack', value: 8 },
            { type: 'activeModifier', modifierId: 'imp_auto_impregnate' },
            { type: 'enemyBonus', enemyKeyword: '__all__', damagePercent: 50 },
          ]}),
      ],
    },
    {
      ...
      color: '#44cc22',
      icon: '☠',
      description: 'Spread disease and decay. Poison the dungeon itself.',
      nodes: [
        node('imp_p_toxic', 'Toxic Spores', '25% chance to poison enemies for 4 damage over 4 turns', '☠', '#44cc22',
          1, 1, 1, [],
          { type: 'ability', abilityId: 'imp_toxic_spores' }),
        node('imp_p_hp1', 'Bloated Body', '+6 max HP', '❤', '#66aa44',
          1, 1, 1, [],
          { type: 'stat', stat: 'maxHp', value: 6 }),
        node('imp_p_plague', 'Plague Carrier', 'Poison spreads to adjacent enemies', '🦠', '#33aa11',
          2, 1, 1, ['imp_p_toxic', 'imp_p_hp1'],
          { type: 'ability', abilityId: 'imp_plague_spread' }),
        node('imp_p_def1', 'Mucus Shield', '+3 defense', '🛡', '#669933',
          2, 1, 1, ['imp_p_toxic', 'imp_p_hp1'],
          { type: 'stat', stat: 'defense', value: 3 }),
        node('imp_p_hp2', 'Grotesque Mass', '+8 max HP', '❤', '#88cc44',
          2, 1, 1, ['imp_p_toxic', 'imp_p_hp1'],
          { type: 'stat', stat: 'maxHp', value: 8 }),
        node('imp_p_hp3', 'Pustulent Growth', '+10 max HP', '❤', '#66bb22',
          3, 1, 2, ['imp_p_plague', 'imp_p_def1', 'imp_p_hp2'],
          { type: 'stat', stat: 'maxHp', value: 10 }),
        node('imp_p_def2', 'Bile Armor', '+5 defense', '🛡', '#448822',
          3, 1, 2, ['imp_p_plague', 'imp_p_def1', 'imp_p_hp2'],
          { type: 'stat', stat: 'defense', value: 5 }),
        node('imp_p_puke', 'Projectile Vomit', 'Puke attacks deal AoE poison damage', '🤮', '#aaff22',
          3, 1, 2, ['imp_p_plague', 'imp_p_def1', 'imp_p_hp2'],
          { type: 'ability', abilityId: 'imp_puke_aoe' }),
        node('imp_p_capstone', 'Plague Lord', 'All attacks poison. Immune to poison. +15 max HP.', '💀', '#33ff00',
          4, 1, 2, ['imp_p_hp3', 'imp_p_def2', 'imp_p_puke'],
          { type: 'multi', effects: [
            { type: 'stat', stat: 'maxHp', value: 15 },
            { type: 'activeModifier', modifierId: 'imp_always_poison' },
            { type: 'passive', passiveId: 'imp_poison_immune' },
          ]}),
      ],
    },
    {
      ...
      color: '#22aa44',
      icon: '🪱',
      description: 'Burrow inside enemies. Feed on their life force.',
      nodes: [
        node('imp_x_leech', 'Parasitic Leech', 'Heal 2 HP on hit', '🪱', '#22aa44',
          1, 2, 1, [],
          { type: 'ability', abilityId: 'imp_leech' }),
        node('imp_x_spd1', 'Worm Speed', '+3 speed', '⚡', '#44cc66',
          1, 2, 1, [],
          { type: 'stat', stat: 'speed', value: 3 }),
        node('imp_x_undead', 'Corpse Burrower', '+30% damage to undead', '💀', '#aaddff',
          2, 2, 1, ['imp_x_leech', 'imp_x_spd1'],
          { type: 'enemyBonus', enemyKeyword: '__undead__', damagePercent: 30 }),
        node('imp_x_beast', 'Gut Worm', '+30% damage to beasts', '🐺', '#88cc44',
          2, 2, 1, ['imp_x_leech', 'imp_x_spd1'],
          { type: 'enemyBonus', enemyKeyword: '__beast__', damagePercent: 30 }),
        node('imp_x_atk1', 'Mandible Strike', '+3 attack', '⚔', '#44aa22',
          2, 2, 1, ['imp_x_leech', 'imp_x_spd1'],
          { type: 'stat', stat: 'attack', value: 3 }),
        node('imp_x_all_weapon', 'Barbed Appendages', '+15% damage with all weapons', '⚔', '#66cc44',
          3, 2, 2, ['imp_x_undead', 'imp_x_beast', 'imp_x_atk1'],
          { type: 'weaponProf', weaponKeyword: '__all__', damagePercent: 15 }),
        node('imp_x_exploit', 'Acid Injection', '+40% to poisoned enemies', '🎯', '#aaff44',
          3, 2, 2, ['imp_x_undead', 'imp_x_beast', 'imp_x_atk1'],
          { type: 'ability', abilityId: 'shared_sharp' }),
        node('imp_x_atk2', 'Consume', '+4 attack', '⚔', '#22cc00',
          3, 2, 2, ['imp_x_undead', 'imp_x_beast', 'imp_x_atk1'],
          { type: 'stat', stat: 'attack', value: 4 }),
        node('imp_x_capstone', 'Apex Parasite', 'Heal 5 HP per kill. +5 attack. +50% damage to all.', '🦠', '#00ff44',
          4, 2, 2, ['imp_x_all_weapon', 'imp_x_exploit', 'imp_x_atk2'],
          { type: 'multi', effects: [
            { type: 'stat', stat: 'attack', value: 5 },
            { type: 'ability', abilityId: 'imp_apex_heal' },
            { type: 'enemyBonus', enemyKeyword: '__all__', damagePercent: 50 },
          ]}),
      ],
    },
